...
1. Open RStudio Lab following the steps used before, and then navigate to `lab-notebooks/lab2_gc-tcd` within RStudio Lab.
1. Create a new R notebook inside this directory.  Make sure your data is visible there.
...
8. Compress your notebook, data file(s), and worksheet into a ZIP folder and upload it to Dropbox (Links for [Monday](https://alphonse.github.io/devel/chem370/assignments/submissions.html) or [Wednesday](https://alphonse.github.io/devel/chem370/assignments/submissions-wednesday.html)).
