...
See the [lab syllabus]({{site.baseurl}}/chem370/lab-manual/syllabus.html#grading) for information on how your laboratory grade is determined.


<!--
- Quizzes - 10% (Category 1)
- Exams - 10% (Category 2)
- final exam + midterm 5% (Category 3)
- homework assignments 20% (Category 4)
- in-class activities 20% (Category 5)
- discretionary 10% (Category 6)
- lab 25%
Projected grade???
 -->
