...
\begin{figure}
\centering
\includegraphics{http://businessoverbroadway.com/wp-content/uploads/2019/01/programming_languages_used.png}
...
\addcontentsline{toc}{subsection}{COVID19 Policies}
...
\addcontentsline{toc}{paragraph}{\textbf{Objective} \textbar{} Analyze an unknown mixture on two gas chromatographs to determine the percent composition and then compare the results from each instrument.}
...
\addcontentsline{toc}{section}{Materials (for Instructors)}
...
\addcontentsline{toc}{subsection}{Chemicals}
...
\item
  Your completed
  \href{https://github.com/alphonse/alphonse.github.io/raw/master/chem370/assignments/excel-templates/rotation_gcms_data-analysis.xlsx}{analysis
  sheet}.
\end{itemize}
\end{marginfigure}

\emph{An example notebook is available \href{https://alphonse.github.io/chem370/notebooks/good-example/}{here}}.
...
\item
  Your completed
  \href{https://github.com/alphonse/alphonse.github.io/raw/master/chem370/assignments/excel-templates/rotation_hplc_data-analysis.xlsx}{analysis
  sheet}.
\end{itemize}
\end{marginfigure}
...
\addcontentsline{toc}{chapter}{Appendix 2: R Cookbook}
...
\addcontentsline{toc}{subsection}{Example Lab Notebooks}
