...
ID <- "Sample Z"  # Delete sample A and insert your sample name.  Leave the quotes.
```
...
9. What is the standard deviation of the baseline, in millivolts (mV), for the GC-400?  Provide your answer as the variable `baselineSD.400`.

```{r question-gc-9, purl = TRUE}
baselineSD.400 <- 0    # put your answer between the '<-' and '#'
```
