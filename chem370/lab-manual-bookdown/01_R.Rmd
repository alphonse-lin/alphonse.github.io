...
1. *Install the `chem370learnR` package*: In Rstudio, find the **Console** tab in the lower left pane.  Copy and paste the following lines *exactly*:
      ...
      install_github("dr-fischer/chem370learnR")
      ```
...
The following video shows you how to complete the steps listed below, assuming you have installed the `chem370learnR` package (Exercise 1.2).

<iframe width="640" height="360" src="https://web.microsoftstream.com/embed/video/a2e6c17b-017a-40cd-879e-0d903de4d45e?autoplay=false&amp;showinfo=false" allowfullscreen style="border:none;"></iframe>
