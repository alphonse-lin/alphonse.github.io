...
##### **To Turn In** |  *You should turn a ZIP folder containing:* {-}
  ...
  2. Your data files.  
  3. Your completed [analysis sheet](https://github.com/alphonse/alphonse.github.io/raw/master/chem370/assignments/excel-templates/lab2_gctcd_data-analysis.xlsx).
...
1. Download the Lab 2 (gowmac) Notebook Template [here](/chem370/notebooks) and use it for data processing.
...
8. Compress your notebook, data file(s), and worksheet into a ZIP folder and upload it to Dropbox (Links for [Monday](https://alphonse.github.io/chem370/assignments/submissions-monday.html) or [Wednesday](https://alphonse.github.io/chem370/assignments/submissions-wednesday.html)).
