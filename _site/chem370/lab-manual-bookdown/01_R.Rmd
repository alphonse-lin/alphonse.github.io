...
1. Load the Chem 370 learnR package: Go to the **Packages** tab in the bottom right pane and check `instRumental` on.  You should load this package everytime you start R.
