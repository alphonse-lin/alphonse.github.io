...
- Your data files.  
- Your completed [analysis sheet](https://github.com/alphonse/alphonse.github.io/raw/master/chem370/assignments/excel-templates/rotation_hplc_data-analysis.xlsx).
```
...
- Your complete lab notebook as an .ipynb file, functioning with no errors.  
- Your data files.  
- Your completed [analysis sheet](https://github.com/alphonse/alphonse.github.io/raw/master/chem370/assignments/excel-templates/rotation_ftir_data-analysis.xlsx).
```
...
- Your complete lab notebook as an .ipynb file, functioning with no errors.  
- Your data files.  
- Your completed [analysis sheet](https://github.com/alphonse/alphonse.github.io/raw/master/chem370/assignments/excel-templates/rotation_gcms_data-analysis.xlsx).
```
...
1. Plot your chromatogram as *Relative Abundance (%)* vs. *Time (minutes)*. (See Appendix 2 for R examples)
1. Plot your mass spectra as *Relative Abundance (%)* vs. *m/z*. (See Appendix 2 for R examples)
...
- Your complete lab notebook as an .ipynb file, functioning with no errors.  
- Your data files.  
- Your completed [analysis sheet](https://github.com/alphonse/alphonse.github.io/raw/master/chem370/assignments/excel-templates/rotation_faas_data-analysis.xlsx).
```
